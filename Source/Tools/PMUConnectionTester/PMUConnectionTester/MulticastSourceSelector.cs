...
public partial class MulticastSourceSelector
{
    public MulticastSourceSelector()
    {
        InitializeComponent();
    }
    ...
    public string ConnectionString
    {
        ...
        set
        {
            ...
            if (connectionData.TryGetValue("multicastSource", out string multicastSourceIP))
            {
                ...
                Forms.PMUConnectionTester.AssignHostIP(TextBoxMulticastSourceIP, multicastSourceIP);
            }
            else
            {
