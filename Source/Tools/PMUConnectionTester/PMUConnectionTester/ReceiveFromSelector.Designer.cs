...
{
    public partial class ReceiveFromSourceSelector : Form
    {
        ...
        {
            TextBoxUdpSourceIP = new Infragistics.Win.UltraWinMaskedEdit.UltraMaskedEdit();
            ...
            // TextBoxUdpSourceIP
            // 
            TextBoxUdpSourceIP.AutoSize = false;
            TextBoxUdpSourceIP.EditAs = Infragistics.Win.UltraWinMaskedEdit.EditAsType.UseSpecifiedMask;
            TextBoxUdpSourceIP.Enabled = false;
            TextBoxUdpSourceIP.InputMask = @"nnn\.nnn\.nnn\.nnn";
            TextBoxUdpSourceIP.Location = new Point(152, 35);
            TextBoxUdpSourceIP.Name = "TextBoxUdpSourceIP";
            TextBoxUdpSourceIP.PromptChar = ' ';
            TextBoxUdpSourceIP.Size = new Size(92, 20);
            TextBoxUdpSourceIP.TabIndex = 2;
            TextBoxUdpSourceIP.Text = "127.0.0.1";
            // 
            ...
            Controls.Add(TextBoxUdpSourceIP);
            Controls.Add(RadioButtonSpecificSource);
            Controls.Add(RadioButtonAnySource);
            FormBorderStyle = FormBorderStyle.FixedDialog;
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "ReceiveFromSourceSelector";
            ShowIcon = false;
            ShowInTaskbar = false;
            SizeGripStyle = SizeGripStyle.Hide;
            StartPosition = FormStartPosition.CenterParent;
            Text = "Select UDP Receive From Source IP Filter";
            ResumeLayout(false);
            PerformLayout();
        }

        internal Infragistics.Win.UltraWinMaskedEdit.UltraMaskedEdit TextBoxUdpSourceIP;
