...
</li><li><strong>Angle</strong>: Displays the measured phase angle of the currently selected Phasor (<a href="#config_frame">Configuration Frame</a>) received in the frame.
